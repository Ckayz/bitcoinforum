/*
  # Bitcoin Forum Database Setup

  1. New Tables
    - `users` - User profiles (id, username, email, bio, avatar_url, created_at)
    - `categories` - Forum categories (id, name, description, created_at)
    - `threads` - Discussion threads (id, category_id, user_id, title, created_at)
    - `posts` - Individual posts (id, thread_id, user_id, content, created_at)
  ...
  3. Default Data
    - Pre-populate with 8 Bitcoin-focused categories
*/
